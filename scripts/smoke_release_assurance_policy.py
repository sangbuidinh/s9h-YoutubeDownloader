...
def main() -> int:
    ...
    cases: list[tuple[str, str, dict[str, Any]]] = [
        ...
        ("production provenance readiness true", "provenance-readiness", {"mutation": _set(("provenance", "production_readiness"), True)}),
        ("production attestation generated", "provenance-readiness", {"mutation": _set(("provenance", "production_attestation_generated"), True)}),
        ...
        ("synthetic integration implementation removed", "synthetic-integration", {"mutation": _set(("provenance", "synthetic_ci_integration", "integration_implemented"), False)}),
        ("synthetic immutable pin integration removed", "synthetic-integration", {"mutation": _set(("provenance", "synthetic_ci_integration", "immutable_action_pin_integrated"), False)}),
        ...
        ("attestation permission removed", "workflow-permissions", {"mutation": _delete_list_item(("provenance", "workflow_permission_review", "required_job_permissions"), "attestations: write")}),
        ("production verification claimed", "provenance-verification", {"mutation": _set(("provenance", "verification", "production_verification_completed"), True)}),
